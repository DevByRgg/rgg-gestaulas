...
public class PublicHomeController {
	...
	private ModelAndView consultaAulas (List<Aula> aulasDisponibles, int sedeSeleccionada, 
		...
		mav.setViewName("public/buscarAula");
		return mav;
		}
	...
	public ModelAndView mostrarHomePage() {
		...
		ModelAndView mav = consultaAulas(aulas, -1, -1, -1, -1, 0);
	...
	public ModelAndView verHorarioPage(
		...
		mav.setViewName("public/verHorario");
	...
	public String addMesHorarioPage(
		...
		return "redirect:/verHorarioAula?mes=" + nextMes + "&anio=" + nextAnio +
	...
	public String restarMesHorarioPage(
		...
		return "redirect:/verHorarioAula?mes=" + antMes + "&anio=" + antAnio +
				"&turno=" + turno + "&aula=" + aula;
	}
	...
	public String addAnioHorarioPage(
		...
		return "redirect:/verHorarioAula?mes=" + mes + "&anio=" + nextAnio +
					"&turno=" + turno + "&aula=" + aula;
	}
	...
	public String restarAnioHorarioPage(
		...
		return "redirect:/verHorarioAula?mes=" + mes + "&anio=" + antAnio +
				"&turno=" + turno + "&aula=" + aula;
	}
	...
	public String addAulaHorarioPage(
		...
		return "redirect:/verHorarioAula?mes=" + mes + "&anio=" + anio +
