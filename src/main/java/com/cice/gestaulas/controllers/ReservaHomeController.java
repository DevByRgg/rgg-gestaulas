...
public class ReservaHomeController extends ReservaAuxiliarController{
	...
	public String crearReserva(
		...
		List<LocalTime> listaHoras = generarHorasLectivas(man09, man10, man11, man12, man13, man14, tar17,
	...
	public ModelAndView buscarReserva(
		...
		for (int i = 0; i < aulasValidas.size(); i++) {
			...
			ObjetoPresentacion o = new ObjetoPresentacion(a.getId(), a.getNombre(), s.getId(),
					s.getNombre(), t.getId(), t.getNombre(), 0);
		...
		for (int i = 0; i < aulasNoValidas.size(); i++) {
			...
			ObjetoPresentacion o = new ObjetoPresentacion(a.getId(), a.getNombre(), s.getId(),
					s.getNombre(), t.getId(), t.getNombre(), coincidencias);
	...
	public ModelAndView actualizaReserva(
